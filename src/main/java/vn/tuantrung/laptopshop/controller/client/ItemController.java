...
public class ItemController {
    ...
    public String getProductPage(Model model,
            ...
            @RequestParam("target") Optional<String> targeOptional,
            @RequestParam("price") Optional<String> priceOptional,          
            @RequestParam("sort") Optional<String> sorOptional) {
        int page = 1;
        try {
        ...
        // Page<Product> prs = this.productService.getProductsWithSpec(pageable, factory);
